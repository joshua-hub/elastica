...
Compiled as gcc as10-melsom-42593249-1.c tridiag.c -o as10 -Wall -lm
_____________________________________________________________________________*/
...
int main () {
  ...
  printf("Please type the output filename: ");
  scanf("%s", fname);
...
double bisection(double DeltaS, double Pressure) {
  ...
  double lower;          // Theta evluated with initial condition dThetaA
